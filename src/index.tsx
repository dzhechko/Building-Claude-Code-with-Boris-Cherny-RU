    ...
    <header class="bg-white shadow-md sticky top-0 z-50">
        <div class="container mx-auto px-4 py-4">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-4">
                    <button id="searchBtn" class="text-gray-600 hover:text-blue-500 transition">
            ...
            <div id="intro" class="section-content mb-12 fade-in-up">
                ...
                <div class="prose max-w-none">
                    ...
                    <p class="text-lg leading-relaxed text-gray-700 mb-6">
                        Что происходит, когда ты устраиваешься в один из ведущих AI-лабораторий мира — и твой первый пул-реквест отклоняют? 
